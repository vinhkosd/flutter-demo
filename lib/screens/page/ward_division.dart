...
class WardsDivision extends StatefulWidget {
  final String districtCode;

  const WardsDivision({this.districtCode});

  @override
  _WardsDivisionState createState() =>
      _WardsDivisionState(districtCode: this.districtCode);
}

class _WardsDivisionState extends State<WardsDivision> {
  final String districtCode;

  _WardsDivisionState({this.districtCode});

  static String jsonData = "{}";

  static Map<String, dynamic> columnRenders = {
    'ward_symbol': <String, dynamic>{
      'name': 'Ký hiệu',
      'render': (dynamic data) {
        return data["ward_symbol"];
      }
    },
    // 'id': {
    //   'name': 'ID',
    ...
    //   }
    // },
    'ward_code': <String, dynamic>{
      'name': 'Mã',
      'render': (dynamic data) {
        return data["ward_code"];
      }
    },
    'ward_name': <String, dynamic>{
      'name': 'Tên',
      'render': (dynamic data) {
  ...
  Future<void> loadData() async {
    ...
    formData["provinceCode"] = this.districtCode ?? "";
    formData["type"] = "0";
    if (pagination != null) {
    ...
    Map<String, dynamic> tableData = await Utils.getWithForm(
        'national-administrative-directories/wards/${this.districtCode}',
        formData);
