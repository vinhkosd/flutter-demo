...
import 'package:flutter_demo/screens/page/ward_division.dart';
...
class DistrictDivision extends StatefulWidget {
  final String provinceCode;

  const DistrictDivision({this.provinceCode});

  @override
  _DistrictDivisionState createState() =>
      _DistrictDivisionState(provinceCode: this.provinceCode);
}

class _DistrictDivisionState extends State<DistrictDivision> {
  final String provinceCode;

  _DistrictDivisionState({this.provinceCode});

  static String jsonData = "{}";

  static Map<String, dynamic> columnRenders = {
    'district_symbol': <String, dynamic>{
      'name': 'Ký hiệu',
      'render': (dynamic data) {
        return data["district_symbol"];
      }
    },
    // 'id': {
    //   'name': 'ID',
    ...
    //   }
    // },
    'district_code': <String, dynamic>{
      'name': 'Mã',
      'render': (dynamic data) {
        return data["district_code"];
      }
    },
    'district_name': <String, dynamic>{
      'name': 'Tên',
      'render': (dynamic data) {
  ...
  Future<void> loadData() async {
    ...
    Map<String, dynamic> tableData = await Utils.getWithForm(
        'national-administrative-directories/districts/${this.provinceCode}',
        formData);
            ...
            if (selected) {
              Navigator.push(context, MaterialPageRoute(
                builder: (_) => MultiProvider(
                  ...
                  child: WardsDivision(
                        districtCode: elm['district_code'].toString() ?? "")),
                ));
            }
          },
        ));
