...
class ProductChooser extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    vatInput.text =
        this.product.vat != null ? this.product.vat.toString() : "0";
    priceInput.text =
        this.product.price != null ? this.product.price.toString() : "0";
    countInput.text =
        this.product.count != null ? this.product.count.toString() : "0";
                        ...
                        Padding(
                            ...
                            child: Container(
                                ...
                                child: OutlinedButton(
                                  ...
                                  onPressed: () {
                                    this.product.vat =
                                        int.parse(vatInput.text);
                                    this.product.price =
                                        int.parse(priceInput.text);
                                    this.product.count =
                                        int.parse(countInput.text);
